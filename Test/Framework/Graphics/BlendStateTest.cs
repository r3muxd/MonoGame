...
{
    internal class BlendStateGdTest : GraphicsDeviceTestFixtureBase
    {
        [Test]
        ...
        public void ShouldNotBeAbleToMutateStateObjectAfterBindingToGraphicsDevice()
        {
            ...
            BlendStateTest.DoAsserts(blendState, Assert.DoesNotThrow);

            // Can't mutate after binding.
            game.GraphicsDevice.BlendState = blendState;
            BlendStateTest.DoAsserts(blendState, d => Assert.Throws<InvalidOperationException>(d));
    ...
    internal class BlendStateTest
    {
        ...
        public static void DoAsserts(BlendState blendState, Action<TestDelegate> assertMethod)
        {
